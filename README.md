...
### 注力したこと（こだわり等）
* 作業状況を可視化したり，他の人から見られてる感を出したいのなら，キーボードの打鍵数を計測したり，Webカメラを利用するなどの方法も考えられる．しかし，キーボードの打鍵数を指標とし始めるとじっくり考えることに抵抗を感じてしまうようになる可能性もあり，webカメラを使用すると監視されている感が強すぎる．そこで我々は，椅子にデバイスを取り付けるだけという，作業時にユーザーが意識する必要がなく，直接監視されている感も強くないが，ユーザーが努力していることを測定することができるエレガントな方法を採用したこと．
