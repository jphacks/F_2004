...
- 蓄積した集中力のデータをユーザーごとに分析し，ユーザーにはどういう集中力の特性があり，どういうことを意識するとより効率よく仕事することができるかをユーザーに知らせてフィードバックを行う．
- 休んだほうがいいとサジェストするのではなく，「コーヒーを飲みませんか？」や「そろそろ運動するといいですよ！」といった親しみやすいやり方でサジェストを行えるようにする．
